...
class FlytecScraper extends BaseScraper {
  constructor() { super('flytec-computers'); this.baseUrl = 'http://www.flytec.com.py'; }
  async scrape() {
    const page = await this.createPage();
    try {
      await scrapeTxtList(this, page, `${this.baseUrl}/listapreco/html.php`);
      // HTML scrape das categorias principais
      const cats = ['notebooks','tablets','monitores','componentes','perifericos','redes','impressoras','gaming'];
      for (const c of cats) {
        try {
