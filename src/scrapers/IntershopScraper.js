...
class IntershopScraper extends BaseScraper {
  constructor() { super('intershop-importados'); this.baseUrl = 'https://intershop.com.py'; }
  async scrape() {
    const page = await this.createPage();
    try {
      await scrapeTxtList(this, page, 'http://www.pioneerinter.com/lista-de-precos/txt');
      const cats = ['celulares','eletronicos','informatica','perfumes','games','cameras','audio','bebidas','casa','relogios','moda'];
      for (const c of cats) {
        try {
...
module.exports = IntershopScraper;
